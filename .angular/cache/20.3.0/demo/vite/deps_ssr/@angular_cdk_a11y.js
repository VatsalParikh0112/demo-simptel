...
var _IsFocusableConfig = class _IsFocusableConfig {
  /**
   * Whether to count an element as focusable even if it is not currently visible.
   */
  ignoreVisibility = false;
};
__name(_IsFocusableConfig, "IsFocusableConfig");
var IsFocusableConfig = _IsFocusableConfig;
...
var _NoopTreeKeyManager = class _NoopTreeKeyManager {
...
__name(_NoopTreeKeyManager, "NoopTreeKeyManager");
var NoopTreeKeyManager = _NoopTreeKeyManager;
function NOOP_TREE_KEY_MANAGER_FACTORY() {
  return () => new NoopTreeKeyManager();
}
__name(NOOP_TREE_KEY_MANAGER_FACTORY, "NOOP_TREE_KEY_MANAGER_FACTORY");
