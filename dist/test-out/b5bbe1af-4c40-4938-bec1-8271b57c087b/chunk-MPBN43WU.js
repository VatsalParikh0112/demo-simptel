...
function cov_1643fiaf4c() {
  ...
  var hash = "82042addc167bf50a4917e196d122efc774564ff";
  ...
  var coverageData = {
    ...
    inputSourceMap: {
      ...
      sources: ["navbar.ts"],
      names: [],
      mappings: ";;;AAAA,OAAO,EAAE,SAAS,EAAE,MAAM,EAAE,MAAM,eAAe,CAAC;AAClD,OAAO,EAAE,MAAM,EAAE,MAAM,iBAAiB,CAAC;AASlC,IAAM,MAAM,GAAZ,MAAM,MAAM;IAEjB,UAAU;QACR,MAAM,IAAI,KAAK,CAAC,EAAE,CAAC,CAAC;IACtB,CAAC;IACO,MAAM,GAAG,MAAM,CAAC,MAAM,CAAC,CAAC;IAEzB,UAAU,CAAC,IAAY;QAC5B,IAAI,CAAC,MAAM,CAAC,QAAQ,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC;IAC/B,CAAC;CACF,CAAA;AAVY,MAAM;IANlB,SAAS,CAAC;QACT,QAAQ,EAAE,YAAY;QACtB,OAAO,EAAE,EAAE;QACX,8BAA4B;;KAE7B,CAAC;GACW,MAAM,CAUlB",
      sourcesContent: ["import { Component, inject } from '@angular/core';\r\nimport { Router } from '@angular/router';\r\n\r\n\r\n@Component({\r\n  selector: 'app-navbar',\r\n  imports: [],\r\n  templateUrl: './navbar.html',\r\n  styleUrl: './navbar.css'\r\n})\r\nexport class Navbar {\r\n\r\n  navigateTo() {\r\n    throw new Error('');\r\n  }\r\n  private router = inject(Router);\r\n\r\n  public clickEvent(path: string) {\r\n    this.router.navigate([path]);\r\n  }\r\n}"]
    },
    _coverageSchema: "1a1c01bbd47fc00a2c39e90264f33305004495a9",
    hash: "82042addc167bf50a4917e196d122efc774564ff"
  };
...
//# sourceMappingURL=chunk-MPBN43WU.js.map
