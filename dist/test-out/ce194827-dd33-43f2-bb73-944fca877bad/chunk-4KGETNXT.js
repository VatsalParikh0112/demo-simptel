...
function cov_2j7e6z3nmm() {
  ...
  var hash = "c3cc26514bca5fff474ce36dc80093a450d8d932";
  ...
  var coverageData = {
    ...
    inputSourceMap: {
      ...
      names: [],
      mappings: ";;;AAAA,OAAO,EAAE,SAAS,EAA+B,KAAK,EAAE,MAAM,eAAe,CAAC;;AAQvE,IAAM,QAAQ,GAAd,MAAM,QAAQ;WACZ,KAAK,CAAC,QAAQ,EAAU;IAC/B,GAAG,GAAG,CAAA,KAAK,CAAC,QAAgB,CAAA,CAAC,CAAA,+BAA+B;;;;;AAFjD,QAAQ;IANpB,SAAS,CAAC;QACT,QAAQ,EAAE,eAAe;QACzB,OAAO,EAAE,EAAE;QACX,8BAA+B;;KAEhC,CAAC;GACW,QAAQ,CAGpB",
      sourcesContent: ["import { Component, Input, Output, EventEmitter, input } from '@angular/core';\r\n\r\n@Component({\r\n  selector: 'app-section-2',\r\n  imports: [],\r\n  templateUrl: './section-2.html',\r\n  styleUrl: './section-2.css'\r\n})\r\nexport class Section2 {\r\n  name = input.required<string>();\r\n  age = input.required<number>;// initial value 0 kemni muku ?\r\n}"]
    },
    _coverageSchema: "1a1c01bbd47fc00a2c39e90264f33305004495a9",
    hash: "c3cc26514bca5fff474ce36dc80093a450d8d932"
  };
...
var init_section_23 = __esm({
  "src/app/routes/home/section-2/section-2.ts"() {
    ...
    }, __name(_a, "Section2"), // initial value 0 kemni muku ?
    __publicField(_a, "propDecorators", (cov_2j7e6z3nmm().s[3]++, {
      name: [{
        type: Input,
        args: [{
          isSignal: true,
...
//# sourceMappingURL=chunk-4KGETNXT.js.map
