...
`]
  ...
  {
    cov_qx2xqoel7 = /* @__PURE__ */ __name(function() {
...
var init_button3 = __esm({
  "src/app/shared/button/button.ts"() {
    ...
    init_core();
    init_core();
    __name(cov_qx2xqoel7, "cov_qx2xqoel7");
    cov_qx2xqoel7();
    cov_qx2xqoel7().s[0]++;
    Button = (_a = class {
    ...
    }, __name(_a, "Button"), __publicField(_a, "propDecorators", (cov_qx2xqoel7().s[4]++, {
      label: [{
        type: Input,
        args: [{
          isSignal: true,
...
//# sourceMappingURL=chunk-EK7TNUAC.js.map
