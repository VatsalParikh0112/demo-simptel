...
import {
  Section1,
  init_section_1
} from "./chunk-EHQSCCEK.js";
import "./chunk-VYGQZE4F.js";
...
<form class=" border rounded-xl w-min mx-10 p-10 " [formGroup]="profileForm" (ngSubmit)="onSubmit()" cdkTrapFocus>\r
    <input class="border p-1" type="text" placeholder="enter name" formControlName="userName">\r
    @if (profileForm.controls.userName.invalid && profileForm.controls.userName.touched) {\r
    @if (profileForm.controls.userName.hasError('minlength')) {\r
...
<div>Name: {{ formValues.userName }}</div>\r
...
var init_platform2 = __esm({
  "node_modules/@angular/cdk/fesm2022/platform2.mjs"() {
    ...
    __publicField(_Platform, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _Platform, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_Platform, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _Platform, providedIn: "root" }));
    Platform = _Platform;
...
var init_focus_monitor = __esm({
  "node_modules/@angular/cdk/fesm2022/focus-monitor.mjs"() {
    ...
    __publicField(_InputModalityDetector, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _InputModalityDetector, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_InputModalityDetector, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _InputModalityDetector, providedIn: "root" }));
    ...
    __publicField(_FocusMonitor, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusMonitor, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_FocusMonitor, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusMonitor, providedIn: "root" }));
    ...
    __publicField(_CdkMonitorFocus, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _CdkMonitorFocus, deps: [], target: FactoryTarget.Directive }));
    __publicField(_CdkMonitorFocus, "\u0275dir", \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.2.0-rc.1", type: _CdkMonitorFocus, isStandalone: true, selector: "[cdkMonitorElementFocus], [cdkMonitorSubtreeFocus]", outputs: { cdkFocusChange: "cdkFocusChange" }, exportAs: ["cdkMonitorFocus"], ngImport: core_exports }));
...
var init_style_loader = __esm({
  "node_modules/@angular/cdk/fesm2022/style-loader.mjs"() {
    ...
    __publicField(__CdkPrivateStyleLoader, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: __CdkPrivateStyleLoader, deps: [], target: FactoryTarget.Injectable }));
    __publicField(__CdkPrivateStyleLoader, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: __CdkPrivateStyleLoader, providedIn: "root" }));
...
var init_private = __esm({
  "node_modules/@angular/cdk/fesm2022/private.mjs"() {
    ...
    __publicField(__VisuallyHiddenLoader, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: __VisuallyHiddenLoader, deps: [], target: FactoryTarget.Component }));
    __publicField(__VisuallyHiddenLoader, "\u0275cmp", \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "20.2.0-rc.1", type: __VisuallyHiddenLoader, isStandalone: true, selector: "ng-component", exportAs: ["cdkVisuallyHidden"], ngImport: core_exports, template: "", isInline: true, styles: [".cdk-visually-hidden{border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;white-space:nowrap;outline:0;-webkit-appearance:none;-moz-appearance:none;left:0}[dir=rtl] .cdk-visually-hidden{left:auto;right:0}\n"], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None }));
...
var init_breakpoints_observer = __esm({
  "node_modules/@angular/cdk/fesm2022/breakpoints-observer.mjs"() {
    ...
    __publicField(_MediaMatcher, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _MediaMatcher, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_MediaMatcher, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _MediaMatcher, providedIn: "root" }));
    ...
    __publicField(_BreakpointObserver, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _BreakpointObserver, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_BreakpointObserver, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _BreakpointObserver, providedIn: "root" }));
...
var init_observers = __esm({
  "node_modules/@angular/cdk/fesm2022/observers.mjs"() {
    ...
    __publicField(_MutationObserverFactory, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _MutationObserverFactory, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_MutationObserverFactory, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _MutationObserverFactory, providedIn: "root" }));
    ...
    __publicField(_ContentObserver, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ContentObserver, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_ContentObserver, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ContentObserver, providedIn: "root" }));
    ...
    __publicField(_CdkObserveContent, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _CdkObserveContent, deps: [], target: FactoryTarget.Directive }));
    __publicField(_CdkObserveContent, "\u0275dir", \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-rc.1", type: _CdkObserveContent, isStandalone: true, selector: "[cdkObserveContent]", inputs: { disabled: ["cdkObserveContentDisabled", "disabled", booleanAttribute], debounce: "debounce" }, outputs: { event: "cdkObserveContent" }, exportAs: ["cdkObserveContent"], ngImport: core_exports }));
    ...
    __publicField(_ObserversModule, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ObserversModule, deps: [], target: FactoryTarget.NgModule }));
    __publicField(_ObserversModule, "\u0275mod", \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ObserversModule, imports: [CdkObserveContent], exports: [CdkObserveContent] }));
    __publicField(_ObserversModule, "\u0275inj", \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ObserversModule, providers: [MutationObserverFactory] }));
...
var init_a11y_module = __esm({
  "node_modules/@angular/cdk/fesm2022/a11y-module.mjs"() {
    ...
    __publicField(_InteractivityChecker, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _InteractivityChecker, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_InteractivityChecker, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _InteractivityChecker, providedIn: "root" }));
    ...
    __publicField(_FocusTrapFactory, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusTrapFactory, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_FocusTrapFactory, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusTrapFactory, providedIn: "root" }));
    ...
    __publicField(_CdkTrapFocus, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _CdkTrapFocus, deps: [], target: FactoryTarget.Directive }));
    __publicField(_CdkTrapFocus, "\u0275dir", \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-rc.1", type: _CdkTrapFocus, isStandalone: true, selector: "[cdkTrapFocus]", inputs: { enabled: ["cdkTrapFocus", "enabled", booleanAttribute], autoCapture: ["cdkTrapFocusAutoCapture", "autoCapture", booleanAttribute] }, exportAs: ["cdkTrapFocus"], usesOnChanges: true, ngImport: core_exports }));
    ...
    __publicField(_LiveAnnouncer, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _LiveAnnouncer, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_LiveAnnouncer, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _LiveAnnouncer, providedIn: "root" }));
    ...
    __publicField(_CdkAriaLive, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _CdkAriaLive, deps: [], target: FactoryTarget.Directive }));
    __publicField(_CdkAriaLive, "\u0275dir", \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.2.0-rc.1", type: _CdkAriaLive, isStandalone: true, selector: "[cdkAriaLive]", inputs: { politeness: ["cdkAriaLive", "politeness"], duration: ["cdkAriaLiveDuration", "duration"] }, exportAs: ["cdkAriaLive"], ngImport: core_exports }));
    ...
    __publicField(_HighContrastModeDetector, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _HighContrastModeDetector, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_HighContrastModeDetector, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _HighContrastModeDetector, providedIn: "root" }));
    ...
    __publicField(_A11yModule, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _A11yModule, deps: [], target: FactoryTarget.NgModule }));
    __publicField(_A11yModule, "\u0275mod", \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _A11yModule, imports: [ObserversModule, CdkAriaLive, CdkTrapFocus, CdkMonitorFocus], exports: [CdkAriaLive, CdkTrapFocus, CdkMonitorFocus] }));
    __publicField(_A11yModule, "\u0275inj", \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _A11yModule, imports: [ObserversModule] }));
...
var init_a11y = __esm({
  "node_modules/@angular/cdk/fesm2022/a11y.mjs"() {
    ...
    __publicField(_AriaDescriber, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _AriaDescriber, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_AriaDescriber, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _AriaDescriber, providedIn: "root" }));
    ...
    __publicField(_FocusTrapManager, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusTrapManager, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_FocusTrapManager, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _FocusTrapManager, providedIn: "root" }));
    ...
    __publicField(_ConfigurableFocusTrapFactory, "\u0275fac", \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ConfigurableFocusTrapFactory, deps: [], target: FactoryTarget.Injectable }));
    __publicField(_ConfigurableFocusTrapFactory, "\u0275prov", \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-rc.1", ngImport: core_exports, type: _ConfigurableFocusTrapFactory, providedIn: "root" }));
...
function cov_qpxki1azj() {
  ...
  var hash = "5f274811335988a5cc07932b3ca522f6d4406720";
  ...
  var coverageData = {
    ...
    hash: "5f274811335988a5cc07932b3ca522f6d4406720"
  };
  ...
  {
    cov_qpxki1azj = /* @__PURE__ */ __name(function() {
...
var init_contact3 = __esm({
  "src/app/routes/contact/contact.ts"() {
    ...
    init_button();
    init_section_1();
    __name(cov_qpxki1azj, "cov_qpxki1azj");
    cov_qpxki1azj();
    cov_qpxki1azj().s[0]++;
    Contact = (_a = class {
...
var require_contact_spec = __commonJS({
  "src/app/routes/contact/contact.spec.ts"(exports) {
    ...
    fdescribe("Contact", () => {
      ...
      it("should submit from when form is valid and submit func is called", () => {
